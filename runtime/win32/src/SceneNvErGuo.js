...
var NvErGuoLayer = cc.Layer.extend(
{
    ctor:function ()
    {
        ...
        {
            //播放背景音乐
            cc.audioEngine.playMusic(res.sound004_mp3, true);
        }
        else
        {
            //停止播放背景音乐
        ...
        addPlayer(this, "xlnshou01.png", cc.p(435, 410));
    ...
    createPlayerAnimation:function()
    {
        ...
        {
            //从精灵帧缓存池中读取精灵帧对象
            frame = spriteFrameCache.getSpriteFrame("xlnshou0" + i + ".png")
    ...
    {
        //创建粒子
        particle = new cc.ParticleSystem(res.shouye_plist);
        particle.x = width / 2;
        particle.y = height;
    ...
    {
        //女儿国场景中每关的过关分数
        vecScore = [1550, 1715, 1750, 1760, 2005, 2300, 2690, 2720, 2780, 3180, 3550];
        ...
        spriteFrameCache.addSpriteFrames(res.xiaolongnv_plist, res.xiaolongnv_png);
    },
