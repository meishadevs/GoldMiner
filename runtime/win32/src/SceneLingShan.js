...
var LingShanLayer = cc.Layer.extend(
{
    ctor:function ()
    {
        ...
        {
            //播放背景音乐
            cc.audioEngine.playMusic(res.sound006_mp3, true);
        }
        else
        {
            //停止播放背景音乐
        ...
        addPlayer(this, "bjshou01.png", cc.p(440, 410));

        addGunLun(this, cc.p(410, 365));

        createClipNode(this);

        addShengZi(cc.p(400, 360));
    ...
    addCloud:function()
    {
        var cloud1 = new cc.Sprite(res.yun1_png);
        moveNode(cloud1, cc.p(420, 385));
        this.addChild(cloud1);

        var cloud2 = new cc.Sprite(res.yun3_png);
        moveNode(cloud2, cc.p(434, 335));
    ...
    createPlayerAnimation:function()
    {
        ...
        {
            //从精灵帧缓存池中读取精灵帧对象
            frame = spriteFrameCache.getSpriteFrame("bjshou0" + i + ".png")
    ...
    {
        //宝象国场景的过关目标分
        vecScore = [1550, 1780, 2225, 2870, 2560, 2895, 3235, 3540, 3970];
        ...
        spriteFrameCache.addSpriteFrames(res.bajie_plist, res.bajie_png);
    },
