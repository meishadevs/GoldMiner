...
var BaoXiangGuoLayer = cc.Layer.extend(
{
    ctor:function ()
    {
        ...
        addBackground(this, res.bg01_png);

        //添加地图
        addMap(this, "baoxiangguo");
        ...
        addPlayer(this, "tsfang01.png", cc.p(440, 410));
    ...
    createPlayerAnimation:function()
    {
        ...
        {
            //从精灵帧缓存池中读取精灵帧对象
            frame = spriteFrameCache.getSpriteFrame("tsfang0" + i + ".png")
    ...
    {
        //宝象国场景的过关目标分
        vecScore = [370, 690, 810, 835, 840, 910, 1090, 1270, 1300, 1410, 1410, 1820];
